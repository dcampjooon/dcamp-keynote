...
import { THEMES, DEFAULT_THEME, DEFAULT_LAYOUTS, DEFAULT_PAGE, type LayoutSpec, type PageSpec, type Theme } from "@/lib/themes";

type Row = { id: string; name: string; description: string | null; theme: { tokens?: Record<string, string>; surround?: string; swatch?: [string, string]; layouts?: LayoutSpec[]; pdfPath?: string; page?: PageSpec } | null };
